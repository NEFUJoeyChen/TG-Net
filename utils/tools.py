...
def same_padding(images, ksizes, strides, rates):
    ...
    out_rows = (rows + strides[0] - 1) // strides[0]   # 32
    out_cols = (cols + strides[1] - 1) // strides[1]   # 32
    effective_k_row = (ksizes[0] - 1) * rates[0] + 1   # 4
    effective_k_col = (ksizes[1] - 1) * rates[1] + 1   # 4
...
def extract_image_patches(images, ksizes, strides, rates, padding='same'):
    ...
    return patches  # [N, C*k*k, L], L is the total number of such blocks   [25,2048,3721]
